            ...
            public void onClick(View v) {
                switch (v.getId()) {
                    ...
                    case R.id.bt_stoptime:
                        ...
                        aler1.show();
                        WindowManager.LayoutParams lp = aler1.getWindow().getAttributes();
                        lp.width = 1080;
                        lp.height = 720;
                        aler1.getWindow().setAttributes(lp);
                    ...
                    case R.id.bt_time:
                        ...
                        aler2.show();
                        WindowManager.LayoutParams lp_ = aler2.getWindow().getAttributes();
                        lp_.width = 1080;
                        lp_.height = 720;
                        aler2.getWindow().setAttributes(lp_);
