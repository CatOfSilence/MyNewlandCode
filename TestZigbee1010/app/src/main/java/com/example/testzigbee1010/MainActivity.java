package com.example.testzigbee1010;
            ...
            public void handleMessage(@NonNull Message msg) {
                ...
                if(flag) {
                    try {
                        ...
                        tv_wd.setText("" + (int) FourChannelValConvert.getTemperature(vals[0]));
                        tv_sd.setText("" + (int) FourChannelValConvert.getHumidity(vals[1]));
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
                }
