...
public class SensorInstrumentView extends View {
    private String color_outcircle ="#FFD9DCF1" ;//"#DEDEDE";
    private String color_bg_outcircle = "#2690F8";
    private String color_bg_incircle = "#58ADE4";
    private String color_progress = "#FF40FFA3";
    private String color_smart_circle = "#C2B9B0";
    private String color_indicator_left = "#FF40FFA3";
    private String color_indicator_right = "#FF40FFA3";
    private String color_val="#FFFFFFFF";
    ...
    public SensorInstrumentView(Context context) {
        this(context, null);
    }

    public SensorInstrumentView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SensorInstrumentView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void drawCurrentProgressTv(int progress, Canvas canvas) {
        ...
        mPaint.setColor(Color.parseColor(color_val));
        mPaint.setTextAlign(Paint.Align.CENTER);
  ...
  //     canvas.drawText(progress+"%", centerPoint[0], baseLine1, mPaint);
    //    canvas.drawText("范围0-"+maxLange, centerPoint[0], baseLine1, mPaint);
...
//此时求出来的baseline可以使文字竖直居中
     ...
     //   float baseLine2 = outCircleRadius / 20f * 11 - 3 * (fontMetrics.bottom + fontMetrics.top) + centerPoint[1];
       int val =(int)( (progress/100.0)*maxLange);
       canvas.drawText(val+"", centerPoint[0], baseLine1, mPaint);
    ...
    private double maxLange=100.0;

    public double getMaxLange() {
        return maxLange;
    }

    public void setMaxLange(double maxLange) {
